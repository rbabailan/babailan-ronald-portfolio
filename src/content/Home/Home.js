...
function Home() {
    ...
    return (
        <div style={{ overflowX: "hidden" }}>
            <div
                className={style.contentStyle}></div>
            <Navbar />
            <div className={style.flexSB}>
                <motion.div
                    ...
                    <p className={style.homeInfoP}>
                        I am Reactjs developer that loves to build a website.
                        I also like to explore more web technology tools.
                    </p>
                    <button className={style.pickMeButton}><Link to="/Contacts">HIRE ME</Link></button>
                </motion.div>
